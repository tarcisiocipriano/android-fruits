...
object MockData {
    var initialFruits = arrayListOf(
        Fruit(0, "Strawberry", photo = 10, benefits = "Strawberries are highly nutritious.\n" +
        ...
        Fruit(1, "Strawberry", photo = 10, benefits = "Strawberries are highly nutritious.\n" +
                "Their vitamin C, manganese, folate and potassium contents are where they really shine.\n" +
                "Compared to other fruits, strawberries have a relatively low glycemic index. Eating them shouldn’t cause a big blood sugar spike.\n" +
                "Similarly to other berries, strawberries have a high antioxidant capacity, which may reduce your risk of chronic disease.\n" +
                "Animal and test-tube studies have found that strawberries may also help prevent cancer and tumor formation.\n" +
                "Strawberries are rich in several nutrients and antioxidants. Eating them may help control your blood sugar levels and reduce your risk of some diseases."),
        Fruit(2, "Apple", photo = 0, benefits = "Apples are among the most popular fruits, and also happen to be incredibly nutritious.\n" +
        ...
        Fruit(3, "Apple", photo = 0, benefits = "Apples are among the most popular fruits, and also happen to be incredibly nutritious.\n" +
                "They contain a high amount of fiber, vitamin C, potassium and vitamin K. They also provide some B vitamins.\n" +
                "Studies suggest that the antioxidants in apples can promote heart health and reduce the risk of type 2 diabetes, cancer and Alzheimer’s.\n" +
                "The antioxidant activity in apples has also been linked with increased bone density in animal and test-tube studies.\n" +
                "Another notable health benefit of apples is their pectin content.\n" +
                "Pectin is a prebiotic fiber that feeds the good bacteria in your gut and helps improve digestion and metabolic health.\n" +
                "Apples are very nutritious. Their nutrients, antioxidants and fiber may reduce the risk of disease and improve digestion."),
        Fruit(4, "Pineaple", photo = 9, benefits = "Among the tropical fruits, pineapple is a nutrition superstar. One cup (237 ml) of pineapple provides 131% of the Reference Daily Intake (RDI) for vitamin C and 76% of the RDI for manganese.\n" +
        ...
        Fruit(5, "Banana", photo = 2, benefits = "Bananas are rich in vitamins and minerals and have quite a few health benefits to offer.\n" +
        ...
        Fruit(6, "Grape", photo = 5, benefits = "Grapes are very healthy. Their high antioxidant content is what makes them stand out.\n" +
        ...
        Fruit(7, "Avocado", photo = 1, benefits = "Avocado is different from most other fruits.\n" +
        ...
        Fruit(8, "Mango", photo = 7, benefits = "Mangoes are an excellent source of vitamin C.\n" +
        ...
        Fruit(9, "Cherries", photo = 4, benefits = "Cherries are rich in nutrients, especially potassium, fiber and vitamin C.\n" +
        ...
        Fruit(10, "Orange", photo = 8, benefits = "Oranges are one of the most popular and nutritious fruits in the world.\n" +
        ...
        Fruit(11, "Watermelon", photo = 11, benefits = "Watermelon is high in vitamins A and C. It’s also rich in some important antioxidants, including lycopene, carotenoids and cucurbitacin E.\n" +
        ...
        Fruit(12, "Blueberries", photo = 3, benefits = "Blueberries have powerful health benefits.\n" +
        ...
        Fruit(13, "Guava", photo = 6, benefits = "Guava has a remarkable nutrition profile.\n" +
