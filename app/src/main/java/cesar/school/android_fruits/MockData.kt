...
object MockData {
    val initialFruits = arrayListOf(
        Fruit(name = "Strawberry", photo = 10, benefits = "Strawberries are highly nutritious.\n" +
        ...
        Fruit(name = "Apple", photo = 0, benefits = "Apples are among the most popular fruits, and also happen to be incredibly nutritious.\n" +
                ...
                "Pectin is a prebiotic fiber that feeds the good bacteria in your gut and helps improve digestion and metabolic health.\n" +
                "Apples are very nutritious. Their nutrients, antioxidants and fiber may reduce the risk of disease and improve digestion."),
        Fruit(name = "Pineaple", photo = 9, benefits = "Among the tropical fruits, pineapple is a nutrition superstar. One cup (237 ml) of pineapple provides 131% of the Reference Daily Intake (RDI) for vitamin C and 76% of the RDI for manganese (5).\n" +
        ...
        Fruit(name = "Banana", photo = 2, benefits = "Bananas are rich in vitamins and minerals and have quite a few health benefits to offer.\n" +
        ...
        Fruit(name = "Grape", photo = 5, benefits = "Grapes are very healthy. Their high antioxidant content is what makes them stand out.\n" +
        ...
        Fruit(name = "Avocado", photo = 1, benefits = "Avocado is different from most other fruits.\n" +
        ...
        Fruit(name = "Cherries", photo = 4, benefits = "Cherries are rich in nutrients, especially potassium, fiber and vitamin C.\n" +
        ...
        Fruit(name = "Orange", photo = 8, benefits = "Oranges are one of the most popular and nutritious fruits in the world.\n" +
        ...
        Fruit(name = "Watermelon", photo = 11, benefits = "Watermelon is high in vitamins A and C. It’s also rich in some important antioxidants, including lycopene, carotenoids and cucurbitacin E.\n" +
        ...
        Fruit(name = "Blueberries", photo = 3, benefits = "Blueberries have powerful health benefits.\n" +
        ...
        Fruit(name = "Guava", photo = 6, benefits = "Guava has a remarkable nutrition profile.\n" +
